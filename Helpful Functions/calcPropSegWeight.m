function [bodySegWeight,propSegWeight] = calcPropSegWeight(kgMass)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bodySegWeight.shoulderMass =         propSegWeight.shoulderProp*kgMass;

%HAT propWeight
propSegWeight.HATProp =              0.678;
bodySegWeight.HATMass =              propSegWeight.HATProp*kgMass;
